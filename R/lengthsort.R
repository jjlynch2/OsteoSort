...
lengthsort <- function (sort, bone = "femur", side = "both", method = "Quartiles", measurements = NULL, sessiontempdir = NULL, stdout = FALSE, cutoff = 1.5, output_options = TRUE, plot = TRUE) {	
	upperfile = "upper.csv"
	lowerfile = "lower.csv"
