						...
						bsModal("settingssingle", title = "Settings", trigger = "settings2", size = "large", 
							...
							tabPanel("Output",
					 		...
					 		tabPanel("Statistical Parameters",
								...
								sliderInput(inputId = "corlevel1", label = "Association correlation level", min=0.01, max = 1, value = 0.5, step = 0.01),
					 	...
					 	bsModal("settings", title = "Settings", trigger = "settings1", size = "large", 
					 		tabsetPanel(id="tabSelected2",
								...
								tabPanel("Statistical Parameters",
									...
									sliderInput(inputId = "corlevel2", label = "Association correlation level", min=0.01, max = 1, value = 0.5, step = 0.01),
